...
public class MAIDDiskStateManager extends DiskStateManager {

	@Override
	protected double diskStateUpdate(double timestamp, HardDiskDrive hdd,
			OutputType type, AccessType aType) {
		double delay = 0.0;
